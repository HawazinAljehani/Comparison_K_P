 ...
 * @author hawazin
 */
public class Comparison_K_P {
/*
    
    This is a solution to task 2

2.	Perform an experimental comparison of two of the minimum-spanning-tree
    algorithms, Kruskal and priority-queue (pq) based Prim. Develop an
    extensive set of experiments to test and plot the running times of
    these algorithms using the above randomly generated graphs.



so we  comparison, we randomly generate Graphs and send them to Kruskal
    and Prim algorithms and calculate time using System.nanoTime(); in Java
    and divide it  by 1000000 to count the time with milliseconds
